...
public class Neo4jBoltDatabase implements GraphDatabaseApi {
    ...
    @Override
    public GraphCoverageResult execute(String query) {
        return execute(query, Collections.emptyMap());
    }

    @Override
    public GraphCoverageResult execute(String query, Map<String, Object> statementParameters) {
        return new CoverageResults(new Project() {
            @NotNull
            @Override
    ...
    @Override
    public GraphCoverageResult executeBatch(List<String> queries, Map<String, Object> statementParameters) {
       return new CoverageResults(new Project() {
           @NotNull
           @Override
           public String getName() {
